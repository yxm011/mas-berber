  ...
  return (
    <div className="overflow-x-hidden">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-gold">
                  ...
                  <div className="text-gray-600">{t('about.vipRooms')}</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow">
                  ...
                  <span className="font-semibold text-sm">{t('about.professionalTeam')}</span>
                </div>
                <div className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow">
                  <Sparkles className="w-8 h-8 text-gold flex-shrink-0" />
                  <span className="font-semibold text-sm">{t('about.premiumProducts')}</span>
                </div>
                <div className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow">
                  <Users className="w-8 h-8 text-gold flex-shrink-0" />
                  <span className="font-semibold text-sm">{t('about.customerSatisfaction')}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-300 ml-9">
                    <li>• {t('services.cutting.haircut')}</li>
                    <li>• {t('services.cutting.beardcut')}</li>
                    <li>• {t('services.cutting.customDesign')}</li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-heading font-semibold mb-4 text-gold flex items-center">
                    ...
                    {t('services.styling.title')}
                  </h3>
                  <ul className="space-y-2 text-gray-300 ml-9">
                    <li>• {t('services.styling.customCare')}</li>
                    <li>• {t('services.styling.straightening')}</li>
                    <li>• {t('services.styling.waving')}</li>
                    <li>• {t('services.styling.grayColoring')}</li>
                    <li>• {t('services.styling.dyeing')}</li>
                    <li>• {t('services.styling.shapeColoring')}</li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-heading font-semibold mb-4 text-gold flex items-center">
                    ...
                    {t('services.beardCare.title')}
                  </h3>
                  <ul className="space-y-2 text-gray-300 ml-9">
                    <li>• {t('services.beardCare.customBeardCare')}</li>
                    <li>• {t('services.beardCare.beardStraightening')}</li>
                    <li>• {t('services.beardCare.customBeardDesign')}</li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-heading font-semibold mb-4 text-gold flex items-center">
                    ...
                    {t('services.extraServices.title')}
                  </h3>
                  <ul className="space-y-2 text-gray-300 ml-9">
                    <li>• {t('services.extraServices.ingrown')}</li>
                    <li>• {t('services.extraServices.customProducts')}</li>
                    <li>• {t('services.extraServices.waxing')}</li>
                    <li>• {t('services.extraServices.manicure')}</li>
                    <li>• {t('services.extraServices.pedicure')}</li>
                  </ul>
                </div>
              </div>
      ...
      <section id="contact" className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">{t('contact.title')}</h2>
